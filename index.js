...
gamesCard.innerHTML = totalNumberOfGames.toLocaleString('en-US');
...
const description = `
  ...
  ${numberOfUnfundedGames} game${numberOfUnfundedGames === 1 ? '' : 's'} remain unfunded.
`;
...
firstGameName.textContent = topGame.name;
